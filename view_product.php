        ...
        <div class="main main-raised main-product">
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6">
                    ...
                    <h3 class="main-price">Rs. ' . $prod_price . '</h3>
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="info">
                ...
                <p>We ensure timely delivery of your orders, so you can enjoy your fashion without delays.</p>
            </div>
        </div>
        <div class="col-md-4">
            <div class="info">
                ...
                <p>Our products are guaranteed to meet the highest standards of quality, giving you the best shopping experience.</p>
            </div>
        </div>
        <div class="col-md-4">
            <div class="info">
                ...
                <p>Our products are crafted with reliability and security in mind, ensuring you shop with confidence. </p>
            </div>
        </div>
    </div>
</div>
