    ...
    <div class="carousel-inner">
        ...
        <div class="carousel-item">
            <div class="page-header header-filter"
                 style="background-image: url('./dress/gptimg.jpg');background-position:top; ">
                <div class="container">
                    <div class="row">
                        <div class="col-md-6 ml-auto mr-auto text-center">
                            <h1 class="title">VastraSansar</h1>
                            <h4>Your one-stop destination for trendy men's and women's fashion wears.<br>Discover the latest styles and elevate your wardrobe with us!</h4>
                            <br>
                            <div class="buttons">
        ...
        <div class="carousel-item active">
            <div class="page-header header-filter"
            style="background-image: url('./dress/background.jpg');background-position:top; ">
                <div class="container">
                    <div class="row">
...
<div class="" style="background-color: white">
    <div class="section recommended-products">
        <div class="container">
            <div class="row">
                <div class="col-md-8 ml-auto mr-auto text-center">
                    <h2 class="title">Find Your Perfect Look</h2>
                    <h4 class="category text-muted">Of Yours</h4>
